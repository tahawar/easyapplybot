...
class EasyApplyBot:
    ...
    #     for field in form:
    #         question = field.text
    #         print(f'i am the question {question}')
    #         answer = self.ans_question(question.lower())
    #         print(f'i am the answer {answer}')
    #         #radio button
    ...
    # def process_questions(self):
    #     time.sleep(1)  # Wait for all form elements to load properly
    #     form_sections = self.get_elements("fields")  # Assuming get_elements fetches all question sections

    #     for field in form_sections:
    #         question_text = field.text.split('\n')[0]  # Get the first line of text as the question
    #         answer, answer_type = self.ans_question(question_text)

    #         if answer == "user provided":
    #             continue  # Skip if no automatic answer is provided

    #         try:
    #             if answer_type == "text":
    #                 input_field = field.find_element(By.CSS_SELECTOR, "input[type='text']")
    #                 input_field.clear()
    #                 input_field.send_keys(answer)
    #             elif answer_type == "radio":
    #                 radio_option = field.find_element(By.XPATH, f".//label[contains(.,'{answer}')]")
    #                 radio_option.click()
    #             elif answer_type == "dropdown":
    #                 select_element = Select(field.find_element(By.TAG_NAME, 'select'))
    ...
    #         if answer is None:
    #             continue  # If no answer is provided, skip this field
    ...
    #                     first_radio_button = field.find_elements(By.CSS_SELECTOR, "input[type='radio']")[0]
    #                     first_radio_button.click()
    #                 else:
    #                     # Targeting label for better interaction for specific answers
    #                     label = field.find_element(By.XPATH, f".//label[contains(.,'{answer}')]")
    #                     label.click()
    #             elif answer_type == "dropdown":
    #                 if isinstance(answer, dict):  # Handle date fields
    #                     for part, value in answer.items():
    #                         select_element = Select(field.find_element(By.CSS_SELECTOR, f"select[name*='{part.lower()}']"))
    ...
    #     for field in form_sections:
    #         question_text = field.text.split('\n')[0]  # Assume question title is always first
    #         answer, answer_type = self.ans_question(question_text)

    #         if answer is None or answer_type is None:
    #             continue  # Skip if no answer is provided or no action defined
    ...
    #             elif answer_type == "radio":
    #                 if answer == "default first":
    #                     # Safely attempt to click the first radio button
    ...
    #     for field in form_sections:
    #         question_text = field.find_element(By.CSS_SELECTOR, "legend span[aria-hidden='true']").text.strip()
    #         answer, answer_type = self.ans_question(question_text)
    ...
    #             elif answer_type == "radio":
    #                 if answer == "default first":
    #                     # Safely attempt to click the first radio button by targeting the first label within the fieldset
    #                     first_label = field.find_element(By.CSS_SELECTOR, "label")
    #                     first_label.click()
    #                 else:
    #                     # Find and click the label that exactly matches the answer text
    #                     label = field.find_element(By.XPATH, f".//label[contains(.,'{answer}')]")
    #                     label.click()
    #             elif answer_type == "dropdown":
    #                 select_element = Select(field.find_element(By.TAG_NAME, 'select'))
    ...
    #                         log.error(f"No radio buttons found for {question_text}")
    #                 else:
    #                     # This part can be removed if you always use default first
    #                     label = field.find_element(By.XPATH, f".//label[contains(.,'{answer}')]")
    #                     label.click()
    #             elif answer_type == "dropdown":
    #                 select_element = Select(field.find_element(By.TAG_NAME, 'select'))
    ...
    #                 input_field.send_keys(answer)
    #             elif answer_type == "radio":
    #                 # Handling radio buttons by finding the first radio button or specified label
    #                 if answer == "default first":
    #                     # Select the first radio button directly
    #                     first_radio_button = field.find_elements(By.CSS_SELECTOR, "input[type='radio']")
    #                     if first_radio_button:
    #                         first_radio_button[0].click()
    #                     else:
    #                         log.error(f"No radio buttons found for {question_text}")
    #                 else:
    #                     # This will only be reached if a specific label is to be clicked
    #                     label = field.find_element(By.XPATH, f".//label[contains(text(), '{answer}')]")
    #                     label.click()
    #             elif answer_type == "dropdown":
    #                 select_element = Select(field.find_element(By.TAG_NAME, 'select'))
    #                 select_element.select_by_visible_text(answer)
    ...
    #                 checkbox = field.find_element(By.CSS_SELECTOR, "input[type='checkbox']")
    #                 if (answer.lower() == "yes" and not checkbox.is_selected()):
    #                     checkbox.click()
    #             elif answer_type == "dropdown":
    #                 select_element = Select(field.find_element(By.TAG_NAME, 'select'))
    #                 select_element.select_by_visible_text(answer)
    ...
    #                         log.error(f"No radio buttons found for {question_text}")
    #                 else:
    #                     # Try finding the radio button by label text if not using default
    #                     label = field.find_element(By.XPATH, f".//label[contains(text(), '{answer}')]")
    #                     label.click()
    #             elif answer_type == "checkbox":
    #                 checkbox = field.find_element(By.CSS_SELECTOR, "input[type='checkbox']")
    ...
    #                         log.error(f"No radio buttons found for {question_text}")
    #                 else:
    #                     # Select the radio button by the label text
    #                     label = field.find_element(By.XPATH, f".//label[contains(text(), '{answer}')]")
    #                     associated_radio = field.find_element(By.CSS_SELECTOR, f"input[value='{label.get_attribute('for')}']")
    #                     associated_radio.click()
    #             elif answer_type == "checkbox":
    #                 checkbox = field.find_element(By.CSS_SELECTOR, "input[type='checkbox']")
    #                 if (answer.lower() == "yes" and not checkbox.is_selected()):
    #                     checkbox.click()
    ...
    #     for field in form_sections:
    #         question_text = field.text.split('\n')[0]  # Assume question title is always first
    #         answer, answer_type, use_default = self.ans_question(question_text)
    ...
    #             elif answer_type == "radio":
    #                 radio_buttons = field.find_elements(By.CSS_SELECTOR, "input[type='radio']")
    #                 labels = {button.get_attribute('id'): button for button in radio_buttons}
    #                 if use_default:
    #                     # Find and click "Yes" if available; otherwise, click the first available button
    #                     yes_label = next((labels[label] for label in labels if "yes" in label.lower()), None)
    #                     if yes_label:
    #                         yes_label.click()
    #                     else:
    #                         radio_buttons[0].click()
    #                 else:
    #                     # Find the label corresponding to the desired answer
    #                     for label, button in labels.items():
    ...
    #     if "how many" in question_lower or "experience" in question_lower:
    #         return "1", "text"
    #     elif "comfortable working in a remote setting" in question_lower:
    #         return "Yes", "radio"
    #     elif "level of proficiency in english" in question_lower:
    #         return "Professional", "dropdown"
    #     elif "us citizen" in question_lower or "can you legally" in question_lower:
    #         return "Yes", "radio"
    #     elif "gender" in question_lower or "race" in question_lower or "ethnicity" in question_lower:
    #         return "Prefer not to answer", "dropdown"
    #     else:
    #         log.info(f"No preset answer for: {question}")
    #         return "user provided", None  # No processing for this question type
    ...
    #         return "No", "radio"
    #     elif 'do you ' in question_lower or "are you " in question_lower or "have you " in question_lower:
    #         return "Yes", "radio"
    #     elif "us citizen" in question_lower or "can you legally" in question_lower:
    #         return "Yes", "radio"
    #     elif "salary" in question_lower:
    #         return str(self.salary), "text"  # Assuming self.salary is an attribute of the class
    ...
    #         return "Example State", "text"
    #     elif "zip" in question_lower or "postal code" in question_lower:
    #         return "12345", "text"
    #     else:
    #         log.info(f"No preset answer for: {question}")
    #         return None, None  # No processing for this question type

    # def ans_question(self, question):
    #     question_lower = question.lower()
    #     if "your title" in question_lower:
    ...
    #         return {"month": "Current", "year": "Current"}, "date"
    ...
    #         return "12345", "text"
    #     else:
    #         log.info(f"Using default first option for radio: {question}")
    #         return "default first", "radio"  # Default to first radio button if no specific condition met

    # def ans_question(self, question):
    #     question_lower = question.lower()
    #     # Specific answers based on the content of the question
    #     if "your title" in question_lower:
    #         return "Software Engineer", "text"
    #     elif "company" in question_lower:
    #         return "OpenAI", "text"
    ...
    #     elif "zip" in question_lower or "postal code" in question_lower:
    #         return "12345", "text"
    #     elif "proficiency in scripting languages" in question_lower:
    #         return "default first", "radio"  # Assuming "Expert" is always the desired response
    #     elif "do you have experience with aws services" in question_lower:
    #         return "default first", "radio"  # Assuming you want the first option if specific not given
    #     elif "do you have proficiency in scripting languages" in question_lower:
    #         return "default first", "radio"  # Adjust this to default first
    #     elif "earliest start date" in question_lower:
    #         return "Within 0 to 30 days", "radio"
    #     elif "are you open to contract based roles" in question_lower:
    #         return "Yes", "radio"  # Adjust this based on your default choice or specific logic
    #     # Add or adjust other conditions as before
    #     else:
    #         # Default to the first radio button if no specific condition is met
    #         log.info(f"Using default first option for radio: {question}")
    #         return "default first", "radio"
    ...
    #         return "50000", "text"  # Assuming this needs to be filled out as text
    #     else:
    #         # Default to the first radio button for any other unhandled questions
    #         log.info(f"Using default first option for radio: {question}")
    #         return "default first", "radio"
